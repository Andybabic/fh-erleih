<nav id="modeSwitch">
    <ul class="modeSwitchWrapper">
        <li class="modeSwitchButton" data-mode="prepare">
            <svg xmlns="http://www.w3.org/2000/svg" width="16.929" height="22.571" viewBox="0 0 16.929 22.571">
        ...
        <li class="modeSwitchButton" data-mode="return">
            <svg xmlns="http://www.w3.org/2000/svg" width="19.75" height="22.571" viewBox="0 0 19.75 22.571" data-mode="return">
