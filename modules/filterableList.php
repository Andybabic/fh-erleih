...
<div id="filterableList" >
    <button  class="aufklappen uk-button  colorPrimary  uk-align-center uk-flex uk-flex-between">Filter  <span class="showFilterArrow"><svg xmlns="http://www.w3.org/2000/svg" width="34.875" height="34.875" viewBox="0 0 34.875 34.875">
