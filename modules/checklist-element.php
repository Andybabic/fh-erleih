<div class="checklist" data-role="listview">
    ...
    $department = $data["sectorId"]["nameDe"];
            ...
            <div
                ...
                <div class="grid-100 ">
                    ...
                    <div class="uk-flex uk-flex-wrap uk-margin-small-top">
                        <span class="swipeboxBottomBtn"><?=$department?></span>
                        <?php if($descriptionEmpty == false): ?>
                            <button href="#toggle-animation<?= $resID ?>" class="swipeboxBottomBtn iconInformation toggleHandle" uk-toggle="target: #toggle-animation<?= $resID ?>; animation: uk-animation-fade">
                            <span class="turnToggleButton">Details
                    ...
                    <script>
                        //toggle details button icon on click
                        $(".iconInformation ").on("click", function(){
                            const icon = $(this).find("svg");
                            icon.toggleClass("rotateButton");
                        });
                    </script>
                    ...
                    <div class="grid-100 uk-align-left toTop uk-margin-small-top">
