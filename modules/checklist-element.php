                                ...
                                <div class="Swipe_container  grid-100 ">
                                          ...
                                          <div class=" swipe_box_back" >
                                            ...
                                            <a class="link2" href="#modal-sections" uk-toggle>
                                                ...
                                                <div  class="uk-card uk-card-body  space-between-list grid-100 uk-flex-inline blue-20 uk-object-position-top-center" >
                                                                                            ...
                                                                                            <?php  for($item = 0; $item < count($packlist) ; ++$item) { ?>
                                                                                                    <li>
                                                                                                        <label >
                                                                                                            ...
                                                                                                            <!---Start PHP LOOP--->
                                                                                                            <input value="<?=$listData?>" class="checklist-checkbox child" type="checkbox"> <?=$packlist[$item]['nameDe']?> </input>
                                                                                                        </label>
                                                                                                    </li>
                                                                                                    <?php } ?>
                                                                                        </ul>
