                ...
                <div class="uk-grid-margin uk-grid uk-grid-stack" uk-grid>
                    <div class="uk-width-1-1@m">
                        <div class="wrapper-login uk-margin uk-width-large uk-margin-auto uk-card uk-card-default uk-card-body uk-box-shadow-large">
                            <h3 class="uk-card-title uk-text-center"> FH<kursiv>ERLEIH</kursiv></h3>
                            <?php echo $massage; ?>
                            <!-- Login -->
                            <form class="form-login" method="POST" action="../functions/login.php" >
                                <div class="uk-margin">
                                    <div class="uk-inline uk-width-1-1">
                                        ...
                                        <input name="username" placeholder="Benutzername" class="uk-input uk-form-large" type="text" id="input-username" required />
                                    </div>
                                </div>
                                <div class="uk-margin">
                                    <div class="uk-inline uk-width-1-1">
                                        <span class="uk-form-icon" uk-icon="icon: lock"></span>
                                        <input name="password" placeholder="Passwort " class="uk-input uk-form-large" type="password" id="input-password" required />
                                    </div>
                                </div>
                                <div class="uk-margin">
                                    <button type="sumbit" class="uk-button uk-button-primary uk-button-large uk-width-1-1">Login</button>
                                </div>
                            </form>
